...
public class FoodController {
	 ...
	 *  HttpServletResponse : Cookie전송, Fril Download
	 *  HttpSession : 회원가입...
	 *  
	...
	public String food_list(String page,Model model) //Model,RedirectAttributes,HttpServletRequest,HttpServletResponse
	{
		if(page==null)
			page="1";
