        ...
        <table class="table">
          ...
          <tr>
            <td colspan="2" class="text-right">
              ...
              <a href="../food/food_list.do?cno=${vo.cno }" class="btn btn-xs btn-danger">목록</a>
            </td>
          </tr>
        </table>
       </div>
    ...
    while (el.hasChildNodes()) {
      ...
      <div class="row">
        ...
        <c:forEach var="cvo" items="${cList }">
          <div class="col-md-3">
	    <div class="thumbnail">
	      <a href="../food/food_list.do?fno=${cvo.fno }">
	        <img src="${cvo.poster }" title="${cvo.name }" style="width:100%">
	      </a>
	    </div>
	  </div>
       </c:forEach>
