    ...
    <div class="two_third first">
      ...
      <div class="row" id="food_reply">
        <table class="table">
          <tr>
            <td>
              <table class="table" v-for="r in rply_list">
                <tr>
                  <td class="text-left">
                    ◑{{r.name}}({{r.dbday}})
                  </td>
                  <td class="text-right">
                    <span v-if="r.id==sessionId">
                      ...
                      <input type="button" class="btn btn-xs btn-danger" value="삭제">
                    </span>
                  </td>
                </tr>
                <tr>
        ...
        <c:if test="${sessionScope.id!=null }">
          <table class="table">
            <tr>
              <td>
                <textarea rows="5" cols="78" style="float: left;" v-model="msg"></textarea>
                <input type="button" value="댓글쓰기" class="btn btn-sm btn-primary" style="height: 105px"> 
              </td>
            </tr>
          </table>
        </c:if>
  ...
  new Vue({
	  ...
	  methods:{
		  addScript:function(){
			  ...
			  script.src='http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=da4c62aa0d3b6477d367816bc345b1c9&libraries=services'
